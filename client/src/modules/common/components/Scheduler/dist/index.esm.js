...
import { enAU, fr, ko, de, es, ar, ja, ru, zhCN, bg } from 'date-fns/locale';

var day$8 = "Ден";
var week$8 = "Седмица";
var month$8 = "Месец";
var timeline$8 = "Хронология";
var mon$8 = "Пн";
var tue$8 = "Вт";
var wed$8 = "Ср";
var thu$8 = "Чт";
...
function WeekModeView(props) {
  ...
  return /*#__PURE__*/React.createElement(StyledTableContainer$1, {
    ...
    }, column === null || column === void 0 ? void 0 : column.weekDay, " ", column === null || column === void 0 ? void 0 : column.day, "/", column === null || column === void 0 ? void 0 : column.month); //week table header label
...
function DayModeView(props) {
  ...
  return /*#__PURE__*/React.createElement(StyledTableContainer, {
    ...
    return /*#__PURE__*/React.createElement(StyledTableCell, {
      ...
      colSpan: 2,
      key: "weekday-".concat(column === null || column === void 0 ? void 0 : column.day, "-").concat(index)
    }, column === null || column === void 0 ? void 0 : column.weekDay, " ", column === null || column === void 0 ? void 0 : column.day, "/", column === null || column === void 0 ? void 0 : column.month); //day table header label
  }))), /*#__PURE__*/React.createElement(TableBody, null, rows === null || rows === void 0 ? void 0 : rows.map(function (row, rowIndex) {
    var _row$days, _row$data, _row$days2;
